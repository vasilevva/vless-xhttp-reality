...
main() {                                                    # Объявление главной функции
    ...
    setup_firewall                                          # Шаг 3: Настройка firewall
    setup_ssh_keys                                          # Шаг 4: Настройка SSH
    install_fail2ban                                        # Шаг 5: Установка Fail2Ban
    start_services                                          # Шаг 6: Запуск сервисов
    show_info                                               # Шаг 7: Вывод информации
